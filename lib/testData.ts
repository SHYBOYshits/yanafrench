...
export const assignments: Assignment[] = [
  ...
  { id: "speaking-02", title: "Speaking · Hypothetical situations", description: "Record a 90-second answer using the conditional tense.", category: "Speaking", deadline: "Due in 5 days", status: "Not started" },
  { id: "grammar-worksheet", title: "Grammar · Connectors worksheet", description: "Fill-in-the-blank practice on contrast and cause connectors.", category: "Grammar", deadline: "Submitted 2 Oct", status: "Reviewed", score: "9 / 10", feedback: "Strong control of connectors — watch \"donc\" vs \"alors\" in formal writing." },
